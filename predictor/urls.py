...
urlpatterns = [
    ...
    url(r'^gameweek_leaderboard/$', views.gameweek_leaderboard, name='gameweek_leaderboard'),
    url(r'^gameweek_leaderboard/(?P<gameweek>\w{0,50})/$', views.gameweek_leaderboard, name='gameweek_leaderboard'),
    url(r'^gameweek_leaderboard/(?P<gameweek>\w{0,50})/(?P<page>\w{0,50})/$',
        views.gameweek_leaderboard, name='gameweek_leaderboard'),
    url(r'^leaderboard/$', views.leaderboard, name='leaderboard'),
    url(r'^leaderboard/(?P<page>\w{0,50})/$', views.leaderboard, name='leaderboard'),
